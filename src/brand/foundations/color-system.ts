/**
 * Foundation doc: color-system.md
 *
 * Generated from DTCG color tokens + brand context.
 * Documents the brand color scale, semantic token map, usage rules,
 * light/dark theme comparison, and WCAG contrast matrix.
 */
...
/** Generate color-system.md content from brand config */
export function generateColorSystemDoc(_config: NibBrandConfig): string {
  return `# Color System
<!-- nib-foundation: color-system | generated: ${DATE} | do not edit manually -->
